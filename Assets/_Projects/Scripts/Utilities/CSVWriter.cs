...
public class CSVWriter : MonoBehaviour
{
    ...
    public void StartRecording()
    {
        ...
        {
            sw.WriteLine("Time,RPM,Generator Output,Generator Reactive Power,Generator Power Factor,Frequency,Field Current");
        }
    ...
    private void RecordData()
    {
        ...
        float reactivePower = gtgController.reactivePowerOutput;
        float powerFactor = gtgController.generatorPowerFactor;
        float fieldCurrent = gtgController.excitationCurrent;
        ...
        {
            sw.WriteLine($"{time},{rpm},{output},{reactivePower},{powerFactor},{frequency},{fieldCurrent}");
        }
    }
