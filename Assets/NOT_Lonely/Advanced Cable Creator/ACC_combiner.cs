...
namespace NOT_Lonely
{
    ...
    {
        public static void Combine(ACC_Cable[] cables, ACC_CableJoint[] joints, Transform root, string savePath, bool doubleSided, float offset, bool generateLightmapUVs)
        {
            int count = 0;
